...
<section class="quick-links">
  <div class="container quick-grid">
    ...
    <a href="ppdb.php" class="card">
      <img src="/sekolah/assets/icon/pendaftaran.svg" alt="">
      <p>PPDB</p>
    </a>

    <a href="hasilppdb.php" class="card">
...
<section class="spmb">
  <div class="spmb-card">
    <div class="spmb-content">
      <div class="spmb-text">
        <h2>Sudah siap untuk <span>Mendaftar?</span></h2>
        <p>
          Ayo bergabung bersama <strong>SMA Pertiwi Medan</strong> untuk
          membangun masa depan cerah dan menjadi generasi yang cerdas, beriman, dan berprestasi.
        </p>
      ...
      <div class="spmb-image">
        <img src="/sekolah/assets/images/gurusiswa.png" alt="Siswa Mendaftar">
      </div>
    </div>
  </div>
</section>
